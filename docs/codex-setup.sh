...
echo "  claudehome/langfuse-local/docker-compose.yml  # 8-service sidecar stack"
echo "  claudehome/langfuse-local/mcp/mcp.json        # MCP gateway server config"
echo "  claudehome/.claude/settings.local.json        # Project-level Claude Code settings"
...
echo "  yamllint claudehome/langfuse-local/docker-compose.yml"
echo "  jq . claudehome/langfuse-local/mcp/mcp.json"
echo "  jq . claudehome/.claude/settings.local.json"
